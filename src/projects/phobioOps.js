      ...
      <ProjectModal>
        ...
        <Parallax pages={3}>
          <ParallaxLayer offset={0}>
            ...
            <glamorous.Div maxWidth={Sizes.content} margin="0 auto">
              ...
              <p>
                ...
                ideal. It presented the users with every piece of information
                and every available option with very little hierachy. And the
                last thing you want to be doing in a fast pace warehouse
                enviroment is hunting through a dense screen of information for
                the one option you need.
              </p>
              <p>
                The problem was clear and so was the solution. By simplifying
                the interface for the majority of users we could drastically
                increase speed and accuracy while reducing stress and improving
              ...
              <p>
                ...
                was the first time, outside of personal projects, I'd built one
                from scratch! It was an excellent learning experience for me and
                a step in the right direction for Phobio's codebase.
              </p>
              <FullWidth>
                <glamorous.Div maxWidth={Sizes.content} margin="0 auto">
          ...
          <ParallaxLayer offset={0} speed={0.5}>
            ...
            <glamorous.Div position="fixed" top="265px" left="10px">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="auto"
                width="400px"
